...
export function CardInicial({ setNotaAvaliacao, notaAvaliacao, setSubmited }) {
    ...
    return (
        ...
        <button onClick={handleSubmited} className="bg-orange w-full py-3 uppercase text-sm rounded-3xl tracking-1 font-bold hover:bg-white hover:text-orange hover:cursor-pointer duration-500">Submit</button>
      </div>
    )
}